"""
Django settings for config_recettes project.
...
SECRET_KEY = 'django-insecure-2hgneu408x_n-f-zz*%d=@t0tko05kw-vol@*kj@mp19=klcqg'
...
# c'est tous ce qui  est  requette client 
WSGI_APPLICATION = 'config_recettes.wsgi.application'
